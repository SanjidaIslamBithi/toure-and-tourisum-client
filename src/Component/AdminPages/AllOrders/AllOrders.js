...
const ClientBookedList = () => {
  ...
  useEffect(() => {
    const url = ` https://shrouded-dusk-24766.herokuapp.com/admin/allbuyingservices`;
  ...
  return (
    <section className='booking-container'>
      <div className='container shadow-lg'>
        <div className='row'>
          ...
          <div className='col-md-9 col-sm-12 col-12 d-flex justify-content-between py-3'>
            <h2 className='mt-5 pb-4 fw-bold'>
              Check the Booking List Booked By Clients:{' '}
        ...
        <div className='row'>
          <div className='col-md-3 col-3'>{/* <ClientBarPage /> */}</div>
          <div
